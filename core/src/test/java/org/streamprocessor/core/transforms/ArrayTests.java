...
public class ArrayTests {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ArrayTests.class);
    ...
    public static void main(String[] args) {
        ...
        new Schema.Builder()
            ...
            .addArrayField("products", Schema.FieldType.STRING)
            .build();
        ...
        JSONObject json =
          new JSONObject()
              .put("firstname", "Joe")
              .put("products", new JSONArray().put("foo").put("bar").put("hello").put("world"));
