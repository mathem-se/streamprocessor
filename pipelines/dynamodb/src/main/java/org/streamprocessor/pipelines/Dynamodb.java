...
public class Dynamodb {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(Dynamodb.class);
  ...
  public static void main(String[] args) {
    ...
    if (options.getBigQueryDataset() != null) {
      ...
      WriteResult result = tokenized.apply(
      ...
      result
        ...
        .apply(
          MapElements
            ...
            .via(x -> {
              String message =
                (new StringBuilder()).append(" The table was " + x.getTable())
                  .append(" The row was " + x.getRow())
                  .append(" The error was " + x.getError())
                  .toString();
              LOG.error(message);
              return "";
            })
