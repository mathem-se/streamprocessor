...
public class SalesforceTest {
  ...
  public void testCorrectPayload() throws Exception {
    // Test input
    final String payload = "{\"detail\": {\"id\": 123}, \"time\": \"2021-02-22T22:22:22.222Z\", \"EventId\": \"123\"}";
    final PubsubMessage message =
        new PubsubMessage(payload.getBytes(), ImmutableMap.of("uuid", "111", "topic", "salesforce"));
    ...
    PCollection<PubsubMessage> transformOut =
        pipeline
            ...
            .apply("Transform salesforce stream change events", ParDo.of(new SalesforceFn()));
